...
$sql = "select * from mission where id='" . $_GET['id'] . "'";
    ...
    if (in_array($fileActualExt, $allowedExt)) {
        if ($fileErr === 0) {
            if ($fileSize < 5000000000)/* 50mg */ {
                ...
                if ($uploadFile) {
                    $insertAp = mysqli_query($con, "update mission set description='" . $description . "',contenu='" . $contenu . "',image='" . $fileDestination . "' where id= '" . $id . "'");

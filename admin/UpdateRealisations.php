...
$sql = "select * from realisations where id='" . $_GET['id'] . "'";
    ...
    if (in_array($fileActualExtE, $allowedExtE)) {
        if ($fileErrE === 0) {
            if ($fileSizeE < 5000000000)/* 50mg */ {
                ...
                if ($uploadFileE) {
                    $UpdateEquipe = mysqli_query($con, "update realisations set photo=  '" . $fileDestinationE . "' where id= '" . $id . "'");
